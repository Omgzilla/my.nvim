...
keymap("n", "<leader>n", ":set invrnu invnu<CR>", opts)

-- Yes/No to signcolumn
keymap("n", "<leader>c", ":set signcolumn=yes<CR>", opts)
keymap("n", "<leader>C", ":set signcolumn=no<CR>", opts)
...
keymap("n", "<leader>ev", ":Lex 30<CR>", opts)
keymap("n", "<leader>ef", ":Ex 30<CR>", opts)
